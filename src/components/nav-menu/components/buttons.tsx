...
export function instaButton() {
    return (
        <Tooltip>
            <TooltipTrigger>
                <span className="inline-flex items-center justify-center w-10 h-10 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 27" strokeWidth="1.5" stroke="currentColor" className="size-6">
...
export function twitterComButton() {
    return (
        <Tooltip>
            <TooltipTrigger>
                <span className="inline-flex items-center justify-center w-10 h-10 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 28 18" strokeWidth="1.5" stroke="currentColor" className="size-6">
