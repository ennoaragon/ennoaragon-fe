        ...
        <div className="flex flex-col w-full h-full mt-10 justify-center items-center
            ...
            <div className="w-full grid grid-cols-3 gap-4">
                ...
                <div className="w-full col-span-1">
                    <img src={import.meta.env.VITE_ENV_MODE === "production" ? "https://cdn.ennoaragon.com/me.png" : "https://media1.tenor.com/m/fTTVgygGDh8AAAAd/kitty-cat-sandwich.gif"} alt="img" />
                </div>
            </div>
